    ...
    .then(e => {
      ...
      <div id="process_information">
        ...
        <table>
          ...
          <tr><th>Initial call:</th><td>${process.meta.init}</td></tr>
          <tr><th>Current function:</th><td>${process.meta.current}</td></tr>
          <tr><th>Behaviour:</th><td>${process.meta.behaviour}</td></tr>
          ...
          <tr><th>Debug link:</th><td><a href="debug/process/${process.pid}" target="_blank">${process.pid}</a></td></tr>
        </table>
        <table>
